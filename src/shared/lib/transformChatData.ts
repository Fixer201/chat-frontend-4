...
export const transformChatItemFromApi = (
    ...
    lastMessage: {
        ...
        filesSummary:
            apiChatItem.last_message.files_summary,
        hasRepliedMessage:
            apiChatItem.last_message.has_replied_message,
        hasForwardedMessage:
            apiChatItem.last_message.has_forwarded_message,
...
export const transformChatItemToApi = (
    ...
    last_message: {
        ...
        has_replied_message:
            chatItem.lastMessage.hasRepliedMessage,
        has_forwarded_message:
            chatItem.lastMessage.hasForwardedMessage,
