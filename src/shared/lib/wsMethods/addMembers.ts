// Add Members to Chat WebSocket Method
import { AddMembersCallback } from './types'
...
export function addMembersMethod(
    ws: WebSocket | null,
    isConnected: boolean,
    ...
    connectFn: () => void,
): (params: AddMembersParams) => Promise<AddMembersResult> {
    return function addMembersToChat(
