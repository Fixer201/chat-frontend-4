...
import { ApiGroupParticipant, GroupParticipant, Contact } from '../types/contact'
...
export const separateOwnerAndParticipants = (
    ...
    const regularParticipants = participants.filter(p => !p.isOwner)
...
export const contactsToGroupParticipants = (contacts: Contact[]): GroupParticipant[] => {
