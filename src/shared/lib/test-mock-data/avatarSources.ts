...
export const SOURCE_DESCRIPTIONS = {
  ...
  [AVATAR_SOURCES.DICEBEAR]: 'DiceBear - стилизованные аватары',
  [AVATAR_SOURCES.RANDOM_USER]: 'Random User - фото людей',
  [AVATAR_SOURCES.FLICKR]: 'Lorem Flickr - тематические фото',
  [AVATAR_SOURCES.ROBOHASH]: 'RoboHash - уникальные роботы',
