 ...
 */
export function loadChatsFromStorage(): ApiChatItem[] | null {
  try {
    ...
    console.error('Ошибка при чтении чатов из localStorage:', error)
  }
  return null
}
 ...
 */
export function saveChatsToStorage(chats: ApiChatItem[]): void {
  try {
 ...
 */
export function generateAndCacheChats(count: number): ApiChatItem[] {
 ...
 */
export function addChatToStorage(newChat: ApiChatItem): void {
 ...
 */
export function getChatByIdFromStorage(id: number): ApiChatItem | null {
