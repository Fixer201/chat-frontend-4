...
const rowBaseClasses =
    'flex gap-3 px-3 py-2 rounded-xl transition-colors duration-200 select-none cursor-pointer'

const modeClasses: Record<AvatarMode, string> = {
    contact:
        'bg-gray-light hover:bg-[#EFEEF7] active:bg-[#615AA3]/60',
