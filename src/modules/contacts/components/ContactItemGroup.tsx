...
export const ContactItemGroup: React.FC<ContactItemProps> = ({
    contact,
    deleteMode,
    selectedUid,
    selectedContacts,
    ...
    const handleContextMenu = useCallback((e: React.MouseEvent) => {
        ...
        const isOwner = 'isOwner' in contact && contact.isOwner
    ...
    return (
        ...
        >
            ...
            {/* Контекстное меню */}
            <Dropdown open={contextMenuOpen} onOpenChange={setContextMenuOpen} closeOnSelect>
                <Dropdown.Content
                    manualPosition={{ left: contextMenuPosition.x, top: contextMenuPosition.y }}
                    width="auto"
                    minWidth={150}
                    maxWidth={250}
                >
                    <Dropdown.Item danger onSelect={handleDelete}>
                        Удалить
                    </Dropdown.Item>
                </Dropdown.Content>
            </Dropdown>
