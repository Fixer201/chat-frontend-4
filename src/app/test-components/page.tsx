  ...
  return (
    <>
      <div className="mx-auto max-w-xl space-y-8 py-8">
        <h1 className="mb-6 text-2xl font-bold">Test Components</h1>
        ...
        <div>
          <h2 className="mb-2 font-semibold">Avatar: Contact</h2>
          <Avatar
        ...
        <div>
          <h2 className="mb-2 font-semibold">Avatar: Select Contact</h2>
          <p className="mb-2 text-sm text-gray-500">
            Нажмите на строку, чтобы переключить состояние
          </p>
          <Avatar
            src="/images/chatHeader/userAvatar.svg"
            name="Влад Ляшев"
        ...
        <div>
          <h2 className="mb-2 font-semibold">Avatar: Chat</h2>
          <Avatar
            src="/images/chatHeader/userAvatar.svg"
        ...
        <div>
          <h2 className="mb-2 font-semibold">Spinner</h2>
          <Spinner />
        </div>

        <div className="space-y-3">
          <h2 className="font-semibold">Modal Examples</h2>
          <div className="flex flex-wrap gap-3">
            <Button variant="primary" size="md" onClick={() => setDeleteModalOpen(true)}>
              Удалить сообщения
            </Button>
            <Button variant="secondary" size="sm" onClick={() => setProfileModalOpen(true)}>
              Удалить фото профиля
            </Button>
            <Button variant="ghost" color="danger" size="sm" onClick={() => setBlockModalOpen(true)}>
              Заблокировать пользователя
            </Button>
            <Button variant="primary" size="sm" onClick={() => setContactModalOpen(true)}>
              Контакт добавлен
            </Button>
          </div>
        </div>
